...
class M_pengguna extends CI_Model {
	...
	public function select_all() {
		$sql = "SELECT tbl_user.id as id, tbl_user.first_name as first_name,tbl_user.last_name as last_name,tbl_user.phone as phone,
			tbl_user.username as username,tbl_user.email as email,tbl_user.created_on as created_on,tbl_user.last_login as last_login,tbl_user.active as active, tbl_user.id_role as id_role, tbl_role.name as nama_role
			FROM tbl_user 
	...
	public function select_by_id($id) {
		$sql = "SELECT tbl_user.id as id, tbl_user.first_name as first_name,tbl_user.last_name as last_name,tbl_user.phone as phone,
			tbl_user.username as username,tbl_user.email as email,tbl_user.created_on as created_on,tbl_user.last_login as last_login,tbl_user.active as active, tbl_user.id_role as id_role, tbl_user.id_kec as id_kec 
			FROM tbl_user 
