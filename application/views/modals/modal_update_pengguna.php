  ...
  <div class="modal-body form">
    ...
    <div class="form-body well">
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input name="username" placeholder="NIK" class="form-control" type="text" value="<?php echo $dataPengguna->username; ?>">
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
            <select class="form-control " name="id_role" id="id_role" placeholder="Role">
              <option <?=("2"==$dataPengguna->id_role)?'selected="selected"':''; ?> value="2" >Warga</option>
              <option <?=("1"==$dataPengguna->id_role)?'selected="selected"':''; ?> value="1" >Administrator</option>
			  <?php
